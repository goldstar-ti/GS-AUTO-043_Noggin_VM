...
Usage:
    validate_nobbie_data.py LCD
    validate_nobbie_data.py CCC
    validate_nobbie_data.py FPI
"""
  ...
  %(prog)s CCC
    ...
    try:
        ...
        if failed_count > 0:
            ...
            logger.info(f"  python nobbie_process.py {abbreviation} --csv {output_dir / f'{abbreviation.lower()}_remediation_tips_{timestamp}.csv'}")
        logger.info("=" * 80)
